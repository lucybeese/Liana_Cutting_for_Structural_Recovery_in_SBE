...
# Create the plot for ACD_change
plot(ACD_change ~ HALP, SBE, pch = 16, cex = 1.2, xlim = c(0, 250), ylim = c(-6, 6), xlab = "", ylab = "", las = 1, axes = FALSE)

# Map colors to levels of 'combined' variable
colors <- c("Control" = "#8EB2C4", "Planted" = "#652D76", "Planted with lianas removed" = "#DC8B7F")
point_colors <- SBE$combined

# Use the colors for points
points(
  ACD_change ~ HALP,
  SBE,
  pch = 16,
  col = colors[point_colors],
  cex = 1.2
)
...
axis(1, at = seq(0, 250, 50), cex.lab = 1.6, cex.axis = 1.2, col = "grey20", col.axis = "grey20")
axis(2, at = seq(-6, 6, 2), cex.lab = 1.6, cex.axis = 1.2, col = "grey20", col.axis = "grey20")
clipplot(abline(h = 0, col = "grey20", lty = 2), xlim = c(par("usr")[1], par("usr")[2]))

# Add shaded confidence intervals and points
for (grp in levels(new.data$combined)) {
  ...
  line_color <- ifelse(grp == "Control", "#8EB2C4", ifelse(grp == "Planted", "#8E7398", "#EFA7CC"))
...
points(ACD_Change~HALP,new.data[new.data$combined=="Control",],type="l",lwd=3,col="#8EB2C4")
points(ACD_Change~HALP,new.data[new.data$combined=="Planted",],type="l",lwd=3,col="#8E7398")
points(ACD_Change~HALP,new.data[new.data$combined=="Planted with lianas removed",],type="l",lwd=3,col="#EFA7CC")

### NEW ###

plot(New_gap_volume_yr~HALP,SBE, pch=16,col="grey30", cex=1.2,xlim=c(0,250),ylim=c(0,900),xlab="",ylab="",las=1,axes=F)

# Map colors to levels of 'combined' variable
colors <- c("Control" = "#8EB2C4", "Planted" = "#8E7398", "Planted with lianas removed" = "#EFA7CC")
point_colors <- SBE$combined

# Use the colors for points
points(
  New_gap_volume_yr ~ HALP,
  SBE,
  pch = 16,
  col = colors[point_colors],
  cex = 1.2
...
axis(1,at=seq(0,250,50),cex.lab=1.6,cex.axis=1.2,col="grey20",col.axis="grey20")
axis(2,at=seq(0,900,150),cex.lab=1.6,cex.axis=1.2,col="grey20",col.axis="grey20")
points(New_Gap_volume_change_hect~HALP,new.data[new.data$combined=="Control",],type="l",lwd=3,col="#8EB2C4")
points(New_Gap_volume_change_hect~HALP,new.data[new.data$combined=="Planted",],type="l",lwd=3,col="#8E7398")
points(New_Gap_volume_change_hect~HALP,new.data[new.data$combined=="Planted with lianas removed",],type="l",lwd=3,col="#EFA7CC")
...
plot(Existing_proportion_closed_perc_yr~HALP,SBE, pch=16,col="grey30", cex=1.2,xlim=c(0,250),ylim=c(0,18),xlab="",ylab="",las=1,axes=F)
...
# Use the colors for points
points(
  Existing_proportion_closed_perc_yr ~ HALP,
  SBE,
  pch = 16,
  col = colors[point_colors],
  cex = 1.2
...
axis(1,at=seq(0,250,50),cex.lab=1.6,cex.axis=1.2,col="grey20",col.axis="grey20")
axis(2,at=seq(0,18,3),cex.lab=1.6,cex.axis=1.2,col="grey20",col.axis="grey20")
clipplot(abline(h=0,col="grey20",lty=2),xlim=c(par("usr")[1],par("usr")[2]))
points(Existing_proportion_closed_perc_yr~HALP,new.data[new.data$combined=="Control",],type="l",lwd=3,col="#BAE1E1")
points(Existing_proportion_closed_perc_yr~HALP,new.data[new.data$combined=="Planted",],type="l",lwd=3,col="#8E7398")
points(Existing_proportion_closed_perc_yr~HALP,new.data[new.data$combined=="Planted with lianas removed",],type="l",lwd=3,col="#EFA7CC")
